...
from surveil.openstack.common import fileutils


policy_opts = [
    cfg.StrOpt('policy_file',
               default='policy.json',
               help='The JSON file that defines policies.'),
    cfg.StrOpt('policy_default_rule',
               default='default',
               help='Default rule. Enforced when a requested rule is not '
                      'found.'),
    cfg.MultiStrOpt('policy_dirs',
                    default=['policy.d'],
                    help='Directories where policy configuration files are '
