...
class BusinessImpactModulationHandler(handler.Handler):
    ...
    def get(self, name):
        ...
        return businessimpactmodulation.BuisnessImpactModulation(**t)
    ...
    def update(self, name, modulation):
        ...
        if "business_impact_modulation_name" not in modulation_dict.keys():
            modulation_dict['business_impact_modulation_name'] = \
                modulation
    ...
    def get_all(self):
        ...
        modulations = [businessimpactmodulation.BuisnessImpactModulation(**m)
