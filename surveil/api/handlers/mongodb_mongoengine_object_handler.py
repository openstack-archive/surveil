...
class MongoObjectHandler(handler.Handler):
    ...
    def _get_mongoengine_object(self, resource_key_value):
    ...
    def get(self, resource_key_value):
        """Return the resource."""
        mongoengine_object = self._get_mongoengine_object(resource_key_value)
    ...
    def update(self, resource_key_value, resource):
        ...
        r = self._get_mongoengine_object(resource_key_value)
    ...
    def get_all(self):
        ...
        return [
            ...
            for r
            in self.resource_storage.objects()
        ]
