...
class TestStatusHosts(functionalTest.FunctionalTest):
    ...
    def test_get_metric_hosts(self):
        ...
        response = self.get("/v2/status/hosts/ws-arbiter/metrics/load1")
    ...
    def test_time_hosts(self):
        ...
        time = {'begin': json.dumps('2015-04-19T00:09:24Z'),
                'end': json.dumps('2015-04-19T02:09:24Z')}

        response = self.post_json("/v2/status/hosts/srv-monitoring-01/services/load/metrics/load1", params=time)
        ...
        self.assertEqual(
            httpretty.last_request().querystring['q'],
            ["SELECT * metric_load1 WHERE time>= '2015-04-19T00:09:24Z'"
