...
class TestStatusHosts(functionalTest.FunctionalTest):
    ...
    def setUp(self):
        ...
        self.influxdb_response = \
            ...
            'e":"localhost"},"columns":["time","last_chk","last_state_chan' \
            'ge","output","state","state_id","state_type"],"values":[["201' \
            '5-04-19T01:09:24Z",1.429405764e+09,1.429405765316929e+09,"OK ' \
            '- localhost: rta 0.033ms, lost 0%","UP",0,"HARD"]]},{"name":"' \
            'HOST_STATE","tags":{"host_name":"test_keystone"},"columns":["' \
            'time","last_chk","last_state_change","output","state","state_' \
            'id","state_type"],"values":[["2015-04-19T01:09:23Z",1.4294057' \
            '63e+09,1.429405765317144e+09,"OK - 127.0.0.1: rta 0.032ms, lo' \
            'st 0%","UP",0,"HARD"]]},{"name":"HOST_STATE","tags":{"host_na' \
            'me":"ws-arbiter"},"columns":["time","last_chk","last_state_ch' \
            'ange","output","state","state_id","state_type"],"values":[["2' \
            '015-04-19T01:09:24Z",1.429405764e+09,1.429405765317063e+09,"O' \
            'K - localhost: rta 0.030ms, lost 0%","UP",0,"HARD"]]}]}]}'
    ...
    def test_query_hosts(self):
        ...
        expected = json.dumps(
            [{"host_name": "ws-arbiter", "last_check": 1429405764}]
        )
