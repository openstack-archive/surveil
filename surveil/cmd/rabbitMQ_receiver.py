...
def main():
    ...
    daemon_config = {
        "SURVEIL_URL": os.environ.get('SURVEIL_URL', config.get("surveilRabbitMQConsummer", "SURVEIL_URL")),
        "SURVEIL_AUTH_URL": os.environ.get('SURVEIL_AUTH_URL', config.get("surveilRabbitMQConsummer", "SURVEIL_AUTH_URL")),
        "SURVEIL_VERSION": os.environ.get('SURVEIL_VERSION', config.get("surveilRabbitMQConsummer", "SURVEIL_VERSION")),
        "RABBIT_HOST": os.environ.get('RABBIT_HOST', config.get("surveilRabbitMQConsummer","RABBIT_HOST")),
        "RABBIT_PORT": os.environ.get('RABBIT_PORT', config.get("surveilRabbitMQConsummer", "RABBIT_PORT")),
        "QUEUE": os.environ.get('QUEUE',config.get("surveilRabbitMQConsummer", "QUEUE")),
        "RABBIT_USER": os.environ.get('RABBIT_USER', config.get("surveilRabbitMQConsummer", "RABBIT_USER")),
        "RABBIT_PASSWORD": os.environ.get('RABBIT_PASSWORD', config.get("surveilRabbitMQConsummer", "RABBIT_PASSWORD")),
        "OS_AUTH_URL": os.environ.get('OS_AUTH_URL', config.get("surveilRabbitMQConsummer", "OS_AUTH_URL")),
        "OS_USERNAME": os.environ.get('OS_USERNAME', config.get("surveilRabbitMQConsummer", "OS_USERNAME")),
        "OS_PASSWORD": os.environ.get('OS_PASSWORD', config.get("surveilRabbitMQConsummer", "OS_PASSWORD"))
    }
    ...
    def reload_config_threads():
        c = client.Client(daemon_config["SURVEIL_URL"],
