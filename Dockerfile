...
RUN useradd alignak && /opt/surveil/env/bin/pip install pycurl pycurl https://github.com/Alignak-monitoring/alignak/archive/d7f457d5ed94f08d9a6a38809106d3e0d35a1712.tar.gz
